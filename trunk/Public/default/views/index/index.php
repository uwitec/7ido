...
<head>
    ...
    <title>欢乐幻 | 家居 装饰 装修 家纺 饰品</title>
    ...
    <link rel="stylesheet" href="<?php echo  yii::app()->theme->baseUrl ?>/css/tipsy.css" type="text/css" media="screen" />              
    <link rel="stylesheet" href="<?php echo  yii::app()->theme->baseUrl ?>/css/jCarousel.css" type="text/css" media="screen" />  
    
    <!--[if IE]> 
        <link rel="stylesheet" href="<?php echo  yii::app()->theme->baseUrl ?>/css/ie.css" type="text/css" media="screen, projection" /> 
    <![endif]-->
    <!--[if IE 7]>
        <link rel="stylesheet" href="<?php echo  yii::app()->theme->baseUrl ?>/css/ie7.css" type="text/css" media="screen" />
    <![endif]-->
	...
	<script type='text/javascript' src='<?php echo  yii::app()->theme->baseUrl ?>/js/ui.core.js'></script>
	<script type='text/javascript' src='<?php echo  yii::app()->theme->baseUrl ?>/js/jquery.cycle.all.min.js'></script>
	...
	<script type='text/javascript' src='<?php echo  yii::app()->theme->baseUrl ?>/js/jquery.arrowFade.js'></script>
	<script type='text/javascript' src='<?php echo  yii::app()->theme->baseUrl ?>/js/ui.tabs.js'></script>
	<script type='text/javascript' src='<?php echo  yii::app()->theme->baseUrl ?>/js/jquery.custom.js'></script>               
	<script type='text/javascript' src='<?php echo  yii::app()->theme->baseUrl ?>/js/jquery.tweetable.js'></script> 
	
	<script type='text/javascript' src='<?php echo  yii::app()->theme->baseUrl ?>/js/cufon-yui.js'></script>
	<script type='text/javascript' src='<?php echo  yii::app()->theme->baseUrl ?>/js/waukegan.font.js'></script>   
	<!-- END .scripts -->           
...
<body class="no_js">
        ...
        <div class="inner">
            ...
            <div id="nav">
				...
				<ul class="level-1 black">
					...
					<li>
						<a href="<?php echo yii::app()->createUrl('index/index');?>">家</a><span> welcome</span>
						<ul class="sub-menu">
							<li>
								<a href="#">Slider</a>
								<ul class="sub-menu">
					...
					<li>
						<a href="<?php echo yii::app()->createUrl('article/index');?>">新闻</a><span> &amp; skins</span>
						<ul class="sub-menu">
							<li>
								<a href="#">Colors</a>
								<ul class="sub-menu">                           
									<li><a href="<?php echo yii::app()->createUrl('article/index');?>">等</a></li> 
    ...
    <div id="slider">
        ...
        <div class="inner">
            ...
            <div id="bolder-theme" class="panel">
                ...
                <img src="<?php echo  yii::app()->theme->baseUrl ?>/images/slider/face.png" alt="Bolder Theme, for your corporate site" />
            </div>
            ...
            <div id="elegant-theme" class="panel none">
                ...
                <img src="<?php echo  yii::app()->theme->baseUrl ?>/images/slider/butterfly.png" alt="Elegant Theme, for a clean &#038; nice layout" />
            </div>
            ...
            <div id="easy-customize" class="panel none">
                ...
                <img src="<?php echo  yii::app()->theme->baseUrl ?>/images/slider/orange.png" alt="Easy to customize, make your site easily" />
            </div>
            ...
            <div id="versatile-theme" class="panel none">
                ...
                <img src="<?php echo  yii::app()->theme->baseUrl ?>/images/slider/versatile.png" alt="Versatile theme, different color &#038; style" />
            </div>
            ...
            <div id="portfolio-blog" class="panel none">
                ...
                <img src="<?php echo  yii::app()->theme->baseUrl ?>/images/slider/bulb.png" alt="Portfolio + Blog, premium wordpress theme" />
            </div>
        </div>
    ...
    <div id="content">
        ...
        <div class="inner">           
			...
			<div class="box-sections">
			    <img src="<?php echo  yii::app()->theme->baseUrl ?>/images/icons/clipboard48.png" alt="Easy to customize" class="icon" />
			...
			<!-- BOX SECTION -->
			<div class="box-sections">
			    <img src="<?php echo  yii::app()->theme->baseUrl ?>/images/icons/bag48.png" alt="Your corporate site" class="icon" />
			...
			<div class="box-sections last">
			    <img src="<?php echo  yii::app()->theme->baseUrl ?>/images/icons/pictures48.png" alt="Portfolio features" class="icon" />
			...
			<!-- BOX SECTION -->
			<div class="box-sections">
			    <img src="<?php echo  yii::app()->theme->baseUrl ?>/images/icons/mphone48.png" alt="Promotions" class="icon" />
			...
			<!-- BOX SECTION -->
			<div class="box-sections">
			    <img src="<?php echo  yii::app()->theme->baseUrl ?>/images/icons/statistics48.png" alt="Statistics" class="icon" />
			...
			<!-- BOX SECTION -->
			<div class="box-sections last">
			    <img src="<?php echo  yii::app()->theme->baseUrl ?>/images/icons/shopbag48.png" alt="Buy this theme" class="icon" />
	...
	<div class="news-home">
        ...
        <div class="inner">
            ...
            <ul>
                <li><a href="#">Bolder, a new WordPress Theme �C buy it on Theme Forest</a> | January 16, 2011</li>
